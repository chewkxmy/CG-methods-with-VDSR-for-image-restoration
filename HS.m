function [xopt, fopt, gopt, NI, Nf] = HS(f, df, x0, Tolerance, CRestart, MaxIter, delta, ro, minimumofalpha, maxiter)
% HS - Implements a conjugate gradient optimization method with Wolfe conditions
%
% Inputs:
