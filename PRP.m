function [xopt, fopt, gopt, NI, Nf] = PRP(f, df, x0, Tolerance, CRestart, MaxIter, delta, ro, minimumofalpha, maxiter)
% PRP - Implements a conjugate gradient optimization method with Wolfe conditions
%
% Inputs:
