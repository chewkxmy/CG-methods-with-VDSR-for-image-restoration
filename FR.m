function [xopt, fopt, gopt, NI, Nf] = FR(f, df, x0, Tolerance, CRestart, MaxIter, delta, ro, minimumofalpha, maxiter)
% FR - Implements a conjugate gradient optimization method with Wolfe conditions
%
% Inputs:
